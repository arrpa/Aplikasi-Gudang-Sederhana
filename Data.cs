public class Data
{
    ...
    {
        int plus_0401 = IdBarang_0401.Length + 1;

        int[] newIdBarang_0401 = new int[plus_0401];
        string[] newNamaBarang_0401 = new string[plus_0401];
        int[]  newHargaBarang = new int[plus_0401];
        int [] newStokBarang_0401 = new int[plus_0401];
        JenisBarang_0401[] newKategori_0401_0401 = new JenisBarang_0401[plus_0401];
        ...
        for (int i = 0; i < IdBarang_0401.Length; i++)
        {
            ...
            newKategori_0401_0401[i] = Kategori_0401[i];
        }
        ...
        Kategori_0401 = newKategori_0401_0401;
    }
